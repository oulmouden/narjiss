        ...
        <div class="container">
            <nav id="navigation" class="navigation navigation-landscape">
                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    <ul class="nav-menu narjiss-map-menu">
                        <li class="{{ request()->routeIs('public.narjiss.map') ? 'current-menu-item' : '' }}">
                            <a href="{{ route('public.narjiss.map') }}">
                                <span class="menu-title">{{ __('Carte') }}</span>
                            </a>
                        </li>
                    </ul>
