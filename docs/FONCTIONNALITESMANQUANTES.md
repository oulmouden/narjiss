...
| Carte interactive + POI par projet | ✅ `carte.html`, `localisation.html`, `api/poi-lib.php` |
...
|---|---|---|---|---|
| 1 | SEO, partage social, données structurées | ⭐⭐⭐ | 1 j | 1 |
...
| 11 | Contenu éditorial + calculateur de frais d'acquisition | ⭐⭐ | 2–3 j | 3 |
...
**Constat** — vérifié par recherche sur tout le dépôt : aucune `meta
...
**Constat** — aucune page éditoriale. Or c'est à la fois le principal levier
SEO durable et un signal de sérieux.
